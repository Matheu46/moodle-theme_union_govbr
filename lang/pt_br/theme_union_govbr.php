...
/**
 * Strings for component 'theme_union_govbr', language 'pt_br'
 *
...
$string['choosereadme'] = 'Tema baseado no Boost Union que segue as diretrizes do Design System do Governo Brasileiro (Gov.br).';
...
$string['error_403_badge'] = 'Erro 403';
$string['error_403_description'] = 'Você não possui permissão para acessar este recurso. Verifique se está autenticado com a conta correta.';
$string['error_403_title'] = 'Acesso não autorizado';
$string['error_404_badge'] = 'Erro 404';
$string['error_404_description'] = 'O endereço que você tentou acessar não foi encontrado, pode ter sido removido ou estar temporariamente indisponível.';
$string['error_404_title'] = 'Página não encontrada';
$string['error_btn_back'] = 'Voltar';
$string['error_btn_home'] = 'Página Inicial';
$string['error_btn_login'] = 'Fazer Login';
$string['error_debug_code'] = 'Código do erro';
$string['error_debug_moreinfo'] = 'Mais informações sobre este erro';
$string['error_debug_title'] = 'Informações técnicas para administradores (Depuração)';
$string['error_general_badge'] = 'Erro no Sistema';
$string['error_general_description'] = 'Ocorreu uma falha inesperada ao processar sua solicitação. Tente novamente ou retorne à página inicial.';
$string['error_general_title'] = 'Ops! Ocorreu um erro no sistema';
...
$string['footer_logo'] = 'Logo específica do rodapé';
$string['footer_logo_desc'] = 'Envie uma logo específica para ser usada apenas no rodapé. Se deixado em branco, a logo principal do site será utilizada.';
...
$string['govbr_header_background'] = 'Cor de Fundo da Barra Gov.br';
$string['govbr_header_background_dark'] = 'Fundo Escuro';
$string['govbr_header_background_desc'] = 'Escolha entre o fundo claro padrão ou fundo escuro para a barra superior do Governo.';
$string['govbr_header_background_light'] = 'Fundo Claro';
...
$string['govbr_logo_alt'] = 'Logo do governo federal do Brasil';
