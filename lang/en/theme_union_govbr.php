...
$string['footer_logo'] = 'Specific footer logo';
$string['footer_logo_desc'] = 'Upload a specific logo to be used only in the footer. If left blank, the main site logo will be used.';
...
$string['privacy:metadata'] = 'The Union Gov.br theme does not store any personal data.';
